...
# with command line options: RECO -s RAW2DIGI,L1Reco,RECO,PAT --runUnscheduled --data --scenario pp --conditions 76X_dataRun2_v15 --eventcontent RAWRECO,MINIAOD --datatier RAWRECO,MINIAOD --customise Configuration/DataProcessing/RecoTLR.customiseDataRun2Common_25ns,TauAnalysis/MCEmbeddingTools/customisers.customisoptions,TauAnalysis/MCEmbeddingTools/customisers.customiseSelecting --filein /store/data/Run2015D/DoubleMuon/RAW/v1/000/256/675/00000/0E1A0432-805D-E511-92CC-02163E01439B.root --fileout RAWskimmed.root -n 60 --no_exec --python_filename=selection.py --no_exec
...
# Input source
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2015D/DoubleMuon/RAW/v1/000/256/675/00000/0E1A0432-805D-E511-92CC-02163E01439B.root'),
