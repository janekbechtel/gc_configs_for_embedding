...
# with command line options: LHEprodandCLEAN --filein file:RAWskimmed.root --fileout file:lhe_and_cleaned.root --runUnscheduled --mc --conditions 90X_upgrade2017_realistic_v20 --era Run2_2017 --eventcontent RAWRECOSIMHLT,MINIAOD --datatier RAWRECOSIM,MINIAOD --step RAW2DIGI,RECO,PAT --customise TauAnalysis/MCEmbeddingTools/customisers.customisoptions,TauAnalysis/MCEmbeddingTools/customisers.customiseLHEandCleaning_Reselect --no_exec -n -1 --python_filename lheprodandcleaning.py --geometry DB:Extended
...
process.MINIAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:lhe_and_cleaned_inMINIAOD.root'),
...
#set electron embedding
process.externalLHEProducer.switchToEmbeddingPDGID = cms.untracked.int32(11)
