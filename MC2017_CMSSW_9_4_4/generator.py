...
# with command line options: TauAnalysis/MCEmbeddingTools/python/EmbeddingPythia8Hadronizer_cfi.py --filein file:lhe_and_cleaned.root --fileout simulated_and_cleaned.root --conditions 94X_upgrade2018_realistic_v8 --era Run2_2017 --eventcontent RAWRECOSIMHLT --step GEN,SIM,DIGI,L1,DIGI2RAW,HLT,RAW2DIGI,RECO --datatier RAWRECOSIMHLT --customise TauAnalysis/MCEmbeddingTools/customisers.customiseGenerator,TauAnalysis/MCEmbeddingTools/customisers.customisoptions --customise_commands process.source.inputCommands.append('drop *_externalLHEProducer_*_SIM') --beamspot Realistic50ns13TeVCollision -n -1 --python_filename generator.py --geometry DB:Extended --no_exec
...
process.schedule.extend([process.raw2digi_step,process.reconstruction_step,process.endjob_step,process.RAWRECOSIMHLToutput_step])
