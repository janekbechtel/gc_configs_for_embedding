...
# with command line options: PAT -s PAT --filein file:simulated_and_cleaned.root --fileout file:merged.root --runUnscheduled --mc --conditions 94X_upgrade2018_realistic_v8 --era Run2_2017 --eventcontent MINIAODSIM --datatier USER --customise TauAnalysis/MCEmbeddingTools/customisers.customisoptions,TauAnalysis/MCEmbeddingTools/customisers.customiseMerging --customise_commands process.patTrigger.processName = cms.string('SIMembedding') -n -1 --python_filename=merging.py --no_exec
