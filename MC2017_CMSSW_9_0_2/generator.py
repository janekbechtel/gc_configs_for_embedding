...
# with command line options: TauAnalysis/MCEmbeddingTools/python/EmbeddingPythia8Hadronizer_cfi.py --filein file:lhe_and_cleaned.root --fileout simulated_and_cleaned.root --conditions 90X_upgrade2017_realistic_v20 --era Run2_2017 --eventcontent RAWRECOSIMHLT --step GEN,SIM,DIGI,L1,DIGI2RAW,HLT:@frozen2017,RAW2DIGI,RECO --datatier RAWRECOSIMHLT --customise TauAnalysis/MCEmbeddingTools/customisers.customiseGenerator_Reselect,TauAnalysis/MCEmbeddingTools/customisers.customisoptions --customise_commands process.source.inputCommands.append('drop *_externalLHEProducer_*_SIM') --beamspot Realistic50ns13TeVCollision --no_exec -n -1 --python_filename generator.py --geometry DB:Extended
