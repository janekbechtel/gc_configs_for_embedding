...
# with command line options: TauAnalysis/MCEmbeddingTools/python/EmbeddingPythia8Hadronizer_cfi.py --filein file:lhe_and_cleaned.root --fileout simulated_and_cleaned.root --conditions 94X_mc2017_realistic_v13 --era Run2_2017 --eventcontent RAWRECO --step GEN,SIM,DIGI,L1,DIGI2RAW,HLT:2e34v40,RAW2DIGI,RECO --datatier RAWRECO --customise TauAnalysis/MCEmbeddingTools/customisers.customiseGenerator_Reselect --beamspot Realistic25ns13TeVEarly2017Collision --no_exec -n -1 --python_filename generator.py --geometry DB:Extended --mc
