...
# with command line options: RECO -s RAW2DIGI,L1Reco,RECO,PAT --runUnscheduled --data --scenario pp --conditions 94X_dataRun2_ReReco_EOY17_v4 --era Run2_2017 --eventcontent RAWRECO --datatier RAWRECO --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2017,TauAnalysis/MCEmbeddingTools/customisers.customiseSelecting_Reselect --filein file:test.root --fileout RAWskimmed.root -n -1 --no_exec --python_filename=selection.py
...
process.GlobalTag = GlobalTag(process.GlobalTag, '94X_dataRun2_ReReco_EOY17_v4', '')
