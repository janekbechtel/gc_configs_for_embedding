...
# with command line options: PAT -s PAT --filein file:simulated_and_cleaned.root --fileout file:merged.root --runUnscheduled --mc --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --era Run2_2016 --eventcontent MINIAODSIM --datatier USER --customise TauAnalysis/MCEmbeddingTools/customisers.customisoptions,TauAnalysis/MCEmbeddingTools/customisers.customiseMerging_Reselect --customise_commands process.patTrigger.processName = cms.string('SIMembedding') -n -1 --no_exec --python_filename=merging.py
