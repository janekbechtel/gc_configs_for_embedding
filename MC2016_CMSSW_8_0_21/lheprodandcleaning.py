...
# with command line options: LHEprodandCLEAN --filein file:RAWskimmed.root --fileout file:lhe_and_cleaned.root --runUnscheduled --mc --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --era Run2_2016 --eventcontent RAWRECOSIMHLT,MINIAOD --datatier RAWRECOSIM,MINIAOD --step RAW2DIGI,RECO,PAT --customise TauAnalysis/MCEmbeddingTools/customisers.customisoptions,TauAnalysis/MCEmbeddingTools/customisers.customiseLHEandCleaning_Reselect --no_exec -n -1 --python_filename lheprodandcleaning.py
