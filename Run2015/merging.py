...
# with command line options: PAT -s PAT --filein file:simulated_and_cleaned.root --fileout file:merged.root --runUnscheduled --data --scenario pp --conditions 76X_dataRun2_v15 --eventcontent MINIAODSIM --datatier USER --customise TauAnalysis/MCEmbeddingTools/customisers.customisoptions,Configuration/DataProcessing/RecoTLR.customiseDataRun2Common_25ns,TauAnalysis/MCEmbeddingTools/customisers.customiseMerging --customise_commands process.patTrigger.processName = cms.string('SIMembedding') -n -1 --no_exec --python_filename=merging.py --no_exec
